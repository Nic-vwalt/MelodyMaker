...
songs = get_songs('Rock_Music_Midi') #These songs have already been converted from midi to msgpack
...
num_timesteps  = 120 #This is the number of timesteps that we will create at a time
...
with tf.Session() as sess:
    ...
    for i in range(sample.shape[0]):
        ...
        midi_manipulation.noteStateMatrixToMidi(S, "generated_melody_{}".format(i))
    #Graph plotting
    plt.plot(songs, color = 'red', label = 'Training set')
    plt.plot(sample, color = 'blue', label = 'Generated set')
